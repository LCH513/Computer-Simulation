...
num_in_q, server_status, num_in_system;
float area_num_in_q, area_server_status, mean_interarrival, mean_service,
sim_time, time_arrival[Q_LIMIT + 1], time_last_event, time_next_event[3],
total_of_delays,stat_service_time,service_time,area_num_in_system;
FILE* infile, * outfile;
...
void arrive(void) /* Arrival event function. */
{
	...
	if (server_status == BUSY) {
		...
		stat_service_time += service_time;
	}
}
...
void report(void) /* Report generator function. */
{
	...
	fprintf(outfile, "\n\nAverage delay in system%11.3f minutes\n\n",
		(total_of_delays / num_custs_delayed) + (stat_service_time / num_delays_required));
